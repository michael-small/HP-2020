...
return (<Container {...props}>
  <div id="development">
  <h1>Development</h1><h2>（プロダクト開発）</h2>
  </div>
  <p>ブロックチェーンのスケーラビリティ問題を解決するプロダクト「Plasm Network」、ブロックチェーン技術をビジネスへ実装したい企業向けのシステム開発と提供を中心に実施しています。最新の技術と既存の安定性のある技術を組み合わせて提案をしています。
  </p>
  <h2>提供価値</h2>
  <FlexContainer>
  ...
  <ArrowButton label="お問い合わせ" to="/contact" style={{margin:"53px auto 0px"}}/>

  <Hr/>
  <div id="rd">
  <h1>R&amp;D</h1><h2>（研究開発）</h2>
  </div>
  <p>
  ...
  <div id="consulting">
  <h1>Consulting</h1><h2>（技術コンサルティング）</h2>
  </div>
  <p>
